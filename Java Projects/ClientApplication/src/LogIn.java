...
public class LogIn extends JFrame {
	...
	private String currentLoggedID, currentUsername;
	protected String ClientLoginURL = "http://localhost:8888/Client_Servers/ClientLoginServer";
	...
	public LogIn() {
		...
		JLabel lblNewLabel = new JLabel("Lettings Agency Client Application");
		...
		btnNewButton.setBounds(88, 121, 96, 23);
		panel_3.add(btnNewButton);

		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				isValid=false;
				ArrayList<String[]> allClients = null;
				try {
					allClients = getValues();
				...
				{
					String username = client[6];
					String password = client[7];
					
					if(username.equals(enteredUsername) && password.equals(enteredPassword))
					{
						currentLoggedID = client[0];
		...
		btnCreateNewAccount.setBounds(194, 121, 168, 23);
		panel_3.add(btnCreateNewAccount);
	...
	public ArrayList<String[]> getValues() throws IOException, JSONException
	{
		...
		url = new URL( ClientLoginURL+"?method=get&function=secureClient");
		...
		jsonArr = jsonObj.getJSONArray("clients");
